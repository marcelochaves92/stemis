<template>
    <div class="p-8 pb-0">
        <h1 class="text-4xl font-bold mb-4 text-indigo-500">Ingredientes</h1>
    </div>
    <div class="px-8">
        <input type="text" v-model="keyword"
            class="rounded border-2 bg-white border-gray-200 focus:ring-indigo-500 focus:border-indigo-500 mb-3 w-full"
